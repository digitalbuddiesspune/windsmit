...
function Blog() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] font-sans selection:bg-[#00b050] selection:text-white">
...
className="h-[55vh] sm:h-[50vh] md:h-[60vh] w-full pt-20 pb-12 px-4 sm:px-6 relative flex flex-col items-center justify-center bg-slate-900"
      ...
      >
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-800 border border-slate-700 text-[#00b050] text-xs font-bold uppercase tracking-widest mb-4">
            <span className="w-2 h-2 rounded-full bg-[#00b050] animate-pulse" aria-hidden />
            Blog
          </div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight mb-4 leading-tight">
            Windsmit <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00b050] to-[#00b050]">Journal</span>
          </h1>
              ...
              >
                ...
                <div className="p-5 flex flex-col flex-grow">
                  <div className="flex items-center gap-2 flex-wrap mb-2">
                    {post.category && (
                      <span className="px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#00b050]/10 text-[#00b050]">
                        {post.category}
                      </span>
                    )}
                  ...
                  <h3 className="text-lg font-bold text-slate-900 mb-2 leading-snug line-clamp-2">
                    <Link to={`/blog/${post._id}`} className="hover:text-[#00b050] transition-colors">
                      {post.title}
                    </Link>
                  </h3>
                  ...
                  <Link
                    to={`/blog/${post._id}`}
                    className="mt-auto text-sm font-semibold text-[#00b050] inline-flex items-center gap-1.5 hover:text-[#009040]"
                  >
                    Read full article
