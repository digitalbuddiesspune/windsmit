...
const IndustrialCollaboration = () => {
    return (
        <div className="bg-white min-h-screen font-sans selection:bg-yellow-100 selection:text-yellow-900">
            ...
            {/* 1. HERO SECTION */}
            <section className="relative h-screen flex items-center overflow-hidden z-0">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="flex flex-col md:flex-row gap-16 items-center">
                        ...
                        <div className="w-full md:w-1/2">
                            ...
                            <h2 className="text-3xl md:text-5xl font-bold mb-8">Why Architects Choose Windsmit Air</h2>
...
.map((model, i) => (
                                    <div key={i} className="flex gap-4">
                                        ...
                                        <div>
                                            <h4 className="text-xl font-bold text-black mb-2">{model.title}</h4>
