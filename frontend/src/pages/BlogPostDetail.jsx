...
function BlogPostDetail() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-emerald-100 selection:text-emerald-900">
      ...
      {/* --- HERO SECTION --- */}
<div className="relative w-full h-[70vh] md:h-[80vh] bg-slate-900 overflow-visible">
        <img 
          src={post.image} 
          alt={post.title} 
        ...
        {/* Hero Content */}
        <div className="absolute bottom-0 mt-10 left-0 w-full pb-24 md:pb-36 z-10 px-6 overflow-visible">
          <div className="max-w-5xl mx-auto text-center md:text-left overflow-visible">
      ...
      <main className="relative z-20 max-w-5xl mx-auto px-6 -mt-16 mb-24">
        <div className="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/60 p-8 md:p-16 border border-slate-100">
          <div className="flex flex-col lg:flex-row gap-16">
            {/* Share Button - Sticky on the left */}
            <aside className="lg:w-12 flex flex-row lg:flex-col items-center gap-4">
              <div className="sticky top-32 flex flex-row lg:flex-col gap-3 relative" ref={shareDropdownRef}>
                ...
                {showShareDropdown && (
                  <div 
                    className="absolute left-14 lg:left-0 lg:top-14 z-50 bg-white rounded-2xl shadow-2xl border border-slate-100 p-3 min-w-[200px]"
                  >
